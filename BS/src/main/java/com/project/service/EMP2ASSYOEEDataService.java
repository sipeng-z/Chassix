...
import com.project.domain.model.input.EMP2ASSYOEEDataInput;
...
@Service
public class EMP2ASSYOEEDataService extends AbstractService<EMP2ASSYOEEDataInput, EMP2ASSYOEEDataOutput> {

    private String mapperName = "com.project.mapper.mybatis.EMP2ASSYOEEDataMapper.";
    private String traceabilityMapperName = "com.project.mapper.mybatis.EMP2ASSYTraceabilityDataMapper.";
    @Override
    ...
    @Autowired
    private EMP2ASSYTraceabilityDataService emp2ASSYTraceabilityDataService;
     ...
     * @throws Exception
     */
    public boolean EMP2ASSYAdd(EMP2ASSYOEEDataInput input, String line, String device)throws  Exception{
     ...
     * @throws Exception
     */
    public boolean EMP2ASSYUpdate(EMP2ASSYOEEDataInput input,String line,String device) throws Exception{
     ...
     * @throws Exception
     */
    public List<EMP2ASSYOEEDataOutput> generalList(boolean isPager, PageData pageData, String line, String device) throws Exception {
        ...
        return (List<EMP2ASSYOEEDataOutput>) daoImp.findForListSql(mapperName+"list",sqlModel);
    }
     ...
     * @throws Exception
     */
    public EMP2ASSYOEEData getByItemNO(Integer ItemNO, String line, String device) throws Exception {

        PageData pageData = new PageData();
        pageData.put("ItemNO",ItemNO.toString());
        return (EMP2ASSYOEEData) daoImp.findForObject(mapperName+"findByPkId",pageData);
    }
     ...
     * @throws Exception
     */
    public boolean updateDownTime (EMP2ASSYOEEData input,String line,String device) throws Exception{
    ...
    public MachOEETime getUnplannedRunningTime(String DateString, Integer StartRecordNO, Integer EndRecordNO, String line, String device) throws Exception{
        ...
        List<EMP2ASSYOEEDataOutput> list4oee = new ArrayList<>();
        PageData pageData = new PageData();
        ...
        for(EMP2ASSYOEEData g:list4oee){
    ...
    public List<MachValue> getDownTimeWeek(Integer year, Integer weekNo, String line, String device) throws Exception{
        ...
        List<EMP2ASSYOEEDataOutput>  list4oee = this.generalList(false,pageData4tra,line,device);
    ...
    public Double getOeeP(String DateString,Integer StartRecordNO,Integer EndRecordNO,String line,String device) throws Exception{
        ...
        pageData4tra.put("inList",inList);
        List<GeneralPQDataOutput>  tralist = emp2ASSYPQDataService.generallist(false,pageData4tra,line,device);
        Integer totalPer = 0;
    ...
    public Double getOeePAssy(String DateString,Integer StartRecordNO,Integer EndRecordNO,String line,String device) throws Exception{
        ...
        targetpieces = new BigDecimal((float) plannedRunningTime / 25).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
        //per part costs time
        if (targetpieces == 0.00) {
            return 0.00;
        }
        ...
        pageData4tra.put("DateString", DateString);
        pageData4tra.put("inList", inList);
        List<EMP2ASSYTraceabilityDataOutput> tralist = emp2ASSYTraceabilityDataService.generallist(false, pageData4tra, line, device);
    ...
    public MachQT getTargetQuantityAssy(String DateString, Integer StartRecordNO, Integer EndRecordNO, String line, String device) throws Exception{
        ...
        Double targetpieces = new BigDecimal((float) plannedRunningTime / (25)).setScale(2, BigDecimal.ROUND_HALF_UP).doubleValue();
        //for per part costs  expect value
        if (targetpieces == 0.00) {
            qt.setTarget(0.00);
        }
        ...
        Integer Lh = 0;
        Integer Rh = 0;
        for (EMP2ASSYTraceabilityData gt : tralist) {
            if (gt.getPartstatus() != 0) {
                continue;                                //remove the scrap
            }
            if (gt.getSoNumber().equals("SO0580")) {
                Lh++;
            } else {
                Rh++;
            }
