...
@Service
public class CPCWorkBenchService {
    ...
    public String getApiLogin(String username,String password)throws Exception{
        ...
        String url = AppConsts.workBenchLoginUrlCPC;
        auth a = new auth();
    ...
    public static String jsonPostobj(String strURL,String params,String sessionId) throws Exception {
        try {
            ...
            // read
            int length = (int) connection.getContentLength();// get length
            if (length != -1) {
                ...
                String result = new String(data, "UTF-8"); // utf-8 character
                return result;
            }
    ...
    public String getApiData(String sessionId,forapi forjpi) throws Exception{
        ...
        String url = AppConsts.workBenchUrlCPC;
