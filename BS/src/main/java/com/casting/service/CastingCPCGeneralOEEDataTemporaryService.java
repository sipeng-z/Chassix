...
@Service
public class CastingCPCGeneralOEEDataTemporaryService extends AbstractService<CastingCPCGeneralOEEDataTemporaryInput,CastingCPCGeneralOEEDataTemporaryOutput> {

    private final String generalName = AppConsts.CastingCPCGeneralOEEDataTemporaryName;
     ...
     * @throws Exception
     */
    public boolean addnewhalt(CastingCPCGeneralOEEDataTemporaryInput input,String device) throws Exception {

       this.setMapperName(AppConsts.CastingCPCGeneralOEEDataTemporaryName.replace("General",device));
        ...
        List<CastingCPCGeneralOEEDataTemporaryInput> list = new ArrayList<>();
        if (days == 0) {
            //1 same day
            ...
            for (int j = 0; j < times; j++) {
                ...
                r += j;
                CastingCPCGeneralOEEDataTemporaryInput input4list = new CastingCPCGeneralOEEDataTemporaryInput();
        ...
        Boolean flag = false;
        for(CastingCPCGeneralOEEDataTemporaryInput g: list){
     ...
     * @return
     */
    public boolean fixLnB (Integer yearNo,Integer weekNo ,String device) throws Exception{
       this.setMapperName(AppConsts.CastingCPCGeneralOEEDataTemporaryName.replace("General",device));
        ...
        for(int i=0;i<7;i++){
            ...
            CastingCPCGeneralOEEDataTemporaryInput input4L = new CastingCPCGeneralOEEDataTemporaryInput();
            ...
            CastingCPCGeneralOEEDataTemporaryInput input4B = new CastingCPCGeneralOEEDataTemporaryInput();
     ...
     * @throws Exception
     */
    public List<CastingCPCGeneralOEEDataTemporaryOutput> generallist(boolean isPager, PageData pageData, String device) throws Exception {
       this.setMapperName(AppConsts.CastingCPCGeneralOEEDataTemporaryName.replace("General",device));
        ...
        return (List<CastingCPCGeneralOEEDataTemporaryOutput>) daoImp.findForListSql(mapperName+"list",sqlModel);
    }
    ...
    public CastingCPCGeneralOEEDataTemporary findByDateRecord(String DateString, Integer recordNO,String device) throws  Exception{
       this.setMapperName(AppConsts.CastingCPCGeneralOEEDataTemporaryName.replace("General",device));
        PageData pageData = new PageData();
        pageData.put("DateString",DateString);
        pageData.put("RecordNO",recordNO.toString());

        return (CastingCPCGeneralOEEDataTemporary) daoImp.findForObject(mapperName+"findByDateRecord",pageData);
