...
import com.core.dao.sqlutils.SqlCreate;
import com.utils.EscapeToolBox;
...
public class PageData extends HashMap implements Map {
	...
	public String where(PageData pageData) throws ParseException {
		return SqlCreate.where(pageData);
	}
