...
public class EscapeToolBox {
	 ...
	 * 字符串编码<br>
	 * <strong>示例：</strong><br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;String str=" ( caption like '%dddd%' ) ";<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;String escapeStr = escape(str);<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println("编码后："+escapeStr);--%20(%20caption%20like%20'%25dddd%25'%20)%20<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println("解码后："+unescape(escapeStr));--(
	 * caption like '%dddd%' ) <br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println("未编码解码后："+unescape(str));--(
	 * caption like '?dd?)<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println("解码两次后："+escape(escape(str)));--%2520(%2520caption%2520like%2520'%2525dddd%2525'%2520)%2520<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println("中文直接解码后："+unescape("在哪里"));--在哪里<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println(escape("中国"));--%u4E2D%u56FD<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println(unescape("中国"));--中国<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println(unescape("%u4E2D%u56FD"));--中国<br>
	 * 
	 * @param s
	 *            String
	 * @return String
	...
	/**
	 * 字符串解码 说明：本方法保证 不论参数s是否经过escape()编码，均能得到正确的“解码”结果<br>
	 * <strong>示例：</strong><br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;String str=" ( caption like '%dddd%' ) ";<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;String escapeStr = escape(str);<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;System.out.println("编码后："+escapeStr);--%20(%20caption%20like%20'%25dddd%25'%20)%20<br>
